        ...
        <div class="card">
            <div class="card-block">
                ...
                <div class="canvas-wrapper">
                    <form action="{{ Route('prosestambahmtk') }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label class="text-muted">Kode Matakuliah :</label>
                            <input type="text" name="kdMtk" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="text-muted">Nama Matakuliah :</label>
                            <input type="text" name="NmMtk" class="form-control" required>
                        </div>
                        <div class="form-group">
